    ...
    @if ($showModal)
        <div class="fixed inset-0 bg-black/40 flex items-center justify-center">
            <div class="bg-white rounded-md w-1/3 p-6">
                <h2 class="text-xl font-semibold text-gray-800 mb-4">Tambah Data Jenis Kegiatan</h2>
                ...
                <form wire:submit.prevent="update">
                    ...
                    <div class="mb-5">
                        <div class="w-full ">
                            ...
                            <textarea type="text" wire:model="description" id="description" placeholder="Kegiatan belajar mengajar adalah ..."
