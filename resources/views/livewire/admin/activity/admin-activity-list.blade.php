<div>
    <h1 class="font-bold text-simipa-3 text-2xl mb-5">Daftar Kegiatan Siswa</h1>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 border ">
            ...
            <tbody>
                @foreach ($activities as $activity)
                    <tr class="bg-white ">
                        <td class="px-6 py-4">
                            <input type="checkbox" wire:key="{{ $activity->id }}" wire:model.live="selected"
                                value="{{ $activity->id }}">
                        </td>
                        ...
                        <td class="px-6 py-4 flex items-center gap-1">
                            <button wire:click="triggerModalEdit({{ $activity->id }})" class="hover:cursor-pointer">
                            ...
                            <button wire:click="triggerModalDelete({{ $activity->id }})" class="hover:cursor-pointer">
