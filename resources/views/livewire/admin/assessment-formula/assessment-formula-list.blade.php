<div>
    <h1 class="font-bold text-simipa-3 text-2xl mb-5">Daftar Formula Penilaian</h1>
    ...
    <div class="relative overflow-x-auto border border-simipa-4">
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 border ">
            ...
            <tbody>
                @foreach ($assessmentFormula as $at)
                    <tr class="bg-white ">
                        <td class="px-6 py-4">
                            <input type="checkbox" wire:key="{{ $at->id }}" wire:model.live="selected"
                                value="{{ $at->id }}">
                        </td>
                        ...
                        <td class="px-6 py-4 flex items-center gap-1">
                            <button wire:click="triggerModalEdit({{ $at->id }})" class="hover:cursor-pointer">
                            ...
                            <button wire:click="triggerModalDelete({{ $at->id }})" class="hover:cursor-pointer">
