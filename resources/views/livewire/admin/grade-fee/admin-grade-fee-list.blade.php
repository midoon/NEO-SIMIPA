<div>
    <h1 class="font-bold text-simipa-3 text-2xl mb-5">Daftar Tagihan Kelas</h1>
    ...
    <div class="relative overflow-x-auto border border-simipa-4">
        ...
        <div class="p-4 flex items-center justify-between gap-4">
            <input type="text"
                ...
                placeholder="Cari berdasarkan nama atau nisn" wire:model.live.debounce.300ms="search">
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 border ">
            ...
            <tbody>
                @foreach ($gradeFees as $gf)
                    <tr class="bg-white ">
                        <td class="px-6 py-4">
                            <input type="checkbox" wire:key="{{ $gf->id }}" wire:model.live="selected"
                                value="{{ $gf->id }}">
                        </td>
                        ...
                        <td>
                            <a href="#">Daftar tagihan ➡️</a>
                        </td>
                        <td class="px-6 py-4 flex items-center gap-1">
                            <button wire:click="triggerModalEdit({{ $gf->id }})" class="hover:cursor-pointer">
                            ...
                            <button wire:click="triggerModalDelete({{ $gf->id }})" class="hover:cursor-pointer">
    ...
    <livewire:admin.grade-fee.admin-grade-fee-delete-multiple />

    {{--


    <livewire:admin.grade-fee.admin-grade-fee-upload />
     --}}
