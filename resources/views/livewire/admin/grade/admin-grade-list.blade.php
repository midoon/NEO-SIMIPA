            ...
            <tbody>
                @foreach ($grades as $grade)
                    <tr class="bg-white ">
                        ...
                        <td class="px-6 py-4">
                            <a wire:navigate class="hover:cursor-pointer hover:text-blue-500"
                                href="/admin/student?grade_id={{ $grade->id }}">Daftar Siswa➡️</a>
                        </td>
                        <td class="px-6 py-4 flex items-center gap-1">
                            <button wire:click="triggerModalEdit({{ $grade->id }})" class="hover:cursor-pointer">
                            ...
                            <button wire:click="triggerModalDelete({{ $grade->id }})" class="hover:cursor-pointer">
