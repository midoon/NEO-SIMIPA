        ...
        <div class="fixed inset-0 bg-black/40 flex items-center justify-center">
            <div class="bg-white rounded-md w-1/3 p-6">
                ...
                <form wire:submit.prevent="store">
                    <div class="mb-3">
                        <div class="w-full ">
                            <label for="name" class="block font-semibold mb-1">Nama Rombel</label>
                    ...
                    <div class="mb-5">
                        <div class="w-full ">
                            <label for="grade_id" class="block font-semibold mb-1">Kelas</label>
                            <select wire:model="grade_id" id="grade_id" class="border w-full rounded-sm px-2 py-1.5"
                                required>
