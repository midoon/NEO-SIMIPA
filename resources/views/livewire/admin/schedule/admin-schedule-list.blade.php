<div>
    ...
    <div class="relative overflow-x-auto border border-simipa-4">
        ...
        <div class="p-4 flex items-center justify-between gap-4">
            <input type="text"
                ...
                placeholder="Cari jadwal" wire:model.live.debounce.300ms="search">
                ...
                @foreach ($schedules as $schedule)
                    <tr class="bg-white ">
                        ...
                        <td class="px-6 py-4 flex items-center gap-1">
                            <button wire:click="triggerModalEdit({{ $schedule->id }})" class="hover:cursor-pointer">
                            ...
                            <button wire:click="triggerModalDelete({{ $schedule->id }})" class="hover:cursor-pointer">
    ...
    <livewire:admin.schedule.admin-schedule-edit />
    <livewire:admin.schedule.admin-schedule-delete />
    <livewire:admin.schedule.admin-schedule-upload />
    <livewire:admin.schedule.admin-schedule-delete-multiple />
