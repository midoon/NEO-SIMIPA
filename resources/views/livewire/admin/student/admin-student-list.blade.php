        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 border ">
            ...
            <tbody>
                @foreach ($students as $student)
                    <tr class="bg-white ">
                        <td class="px-6 py-4">
                            <input type="checkbox" wire:key="{{ $student->id }}" wire:model.live="selected"
                                value="{{ $student->id }}">
                        </td>
                        ...
                        <td class="px-6 py-4 flex items-center gap-1">
                            <button wire:click="triggerModalEdit({{ $student->id }})" class="hover:cursor-pointer">
                            ...
                            <button wire:click="triggerModalDelete({{ $student->id }})" class="hover:cursor-pointer">
