<div>
    <h1 class="font-bold text-simipa-3 text-2xl mb-5">Daftar Mata Pelajaran</h1>
                    ...
                    <tr class="bg-white ">
                        ...
                        <td class="px-6 py-4">
                            <a wire:navigate class="hover:cursor-pointer hover:text-blue-500"
                                href="/admin/schedule?subject_id={{ $subject->id }}">Daftar Jadwal</a>
                        </td>
                        <td class="px-6 py-4 flex items-center gap-1">
                            <button wire:click="triggerModalEdit({{ $subject->id }})" class="hover:cursor-pointer">
                            ...
                            <button wire:click="triggerModalDelete({{ $subject->id }})" class="hover:cursor-pointer">
