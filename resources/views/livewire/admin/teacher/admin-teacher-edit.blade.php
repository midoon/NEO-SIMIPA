    ...
    @if ($showModalEdit)
        <div class="fixed inset-0 bg-black/40 flex items-center justify-center">
            <div class="bg-white rounded-md w-1/3 p-6">
                <h2 class="text-xl font-semibold text-gray-800 mb-4">Edit Data Guru</h2>
                ...
                <form wire:submit.prevent="update">
                    <div class="mb-3">
                        <div class="flex-1 space-y-2 md:flex md:items-center md:space-x-3 md:space-y-0">
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <input type="text" wire:model="nik" required
                                    class="w-full border py-1.5 px-3 rounded-sm focus:border-simipa-1 focus:ring-1 focus:ring-simipa-1 focus:outline-none">
                                @error('nik')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <select wire:model="gender" class="border w-full rounded-sm px-2 py-1.5" required>
                    ...
                    <div class="mb-7">
                        ...
                        <div class="flex items-center space-x-5 border p-3 rounded-sm">
                            <div>
                                <label>
                                    <input type="checkbox" value="guru" wire:model="roles"
                                        class="mr-2 capitalize">Guru
                                </label>
                            </div>
                            <div>
                                <label>
                                    <input type="checkbox" value="bendahara" wire:model="roles"
