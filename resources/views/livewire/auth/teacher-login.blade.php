<div class="bg-gradient-to-r from-simipa-3  to-simipa-4 w-full">
    <div class="w-full flex justify-center items-center min-h-screen px-8">
        <div class="w-full md:max-w-sm rounded-xl bg-simipa-5 p-10 ">
            ...
            @endif --}}
            <h1 class="text-center text-3xl font-bold text-simipa-3">Login Guru</h1>
            ...
            <div class="mt-10">
                <h3 class="text-simipa-3 font-medium text-center text-sm mb-2">Belum mempunyai akun? daftar <a
                        href="/teacher/register" class="hover:underline text-simipa-1 font-bold"
                        wire:navigate>disini</a></h3>
