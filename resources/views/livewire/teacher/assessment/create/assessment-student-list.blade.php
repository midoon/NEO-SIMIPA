        ...
        <div class="mb-[15vh] ">
            @foreach ($students as $s)
                <div class="flex justify-between items-center mb-3 border-2 border-slate-400 p-2 rounded-md">
                    ...
                    <div>
                        <button wire:click="showModalScore({{ $s->id }})"
                            class="px-3 py-1 rounded-lg bg-simipa-1 text-simipa-5 hover:bg-simipa-2 sm:px-6 sm:py-2 hover:cursor-pointer">Input
                        </button>
                    </div>
                </div>
            @endforeach
