    ...
    @if ($showModal)
        <div class="fixed inset-0 bg-black/40 flex items-center justify-center">
            <div class="bg-white rounded-md mx-4 sm:w-1/3 p-6">
                <h2 class="text-xl font-semibold text-gray-800 mb-4">Konfirmasi Hapus Kehadiran</h2>
                <p>Apakah Anda yakin ingin menghapus daftar kehadiran {{ $activity }} untuk kelas
                    {{ $group }} ?</p>
